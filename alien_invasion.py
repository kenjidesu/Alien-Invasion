...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.play_button = Button(self, "ALIEN", 0)
    ...
    def _check_button(self, mouse_pos):
        ...
        med_clicked = self.medium_button.rect.collidepoint(mouse_pos)
        ...
        if easy_clicked and not self.stats.game_active:
            ...
            self._start_game()
        elif med_clicked and not self.stats.game_active:
    ...
    def _update_aliens(self):
        ...
        Check if the fleet is at an edge,
            then update the positions of all aliensin the fleet
        """
